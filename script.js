...
function janken(tangan){
    ...
    switch(jariKen){
        case 0:
            ken.style.backgroundImage = "url(assets/ken-batu.png)";
            break;
        case 1:
            ken.style.backgroundImage = "url(assets/ken-gunting.png)";
            break;
        default:
            ken.style.backgroundImage = "url(assets/ken-kertas.png)";
            break;
    }
